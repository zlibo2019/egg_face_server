...
if (process.env.NODE_ENV == 'development') {    
    ...
    let ipUrl = location.hostname?location.hostname:"127.0.0.1";
    axios.defaults.baseURL = 'http://'+ipUrl+':7001/';
    ...
    error => {    
        ...
        if (error.response) {      
            ...
            switch (error.response.status) {                
                ...
                default:                    
                    Message({                        
                        message: error.response.data.message?1:2,                        
                        duration: msgDuration,                        
                        forbidClick: true                    
                    });        
            }                  
